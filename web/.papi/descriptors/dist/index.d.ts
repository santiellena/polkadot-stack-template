import { default as asset_hub_paseo, type Asset_hub_paseoWhitelistEntry } from "./asset_hub_paseo";
export { asset_hub_paseo };
export type * from "./asset_hub_paseo";
...
export type WhitelistEntry = Asset_hub_paseoWhitelistEntry | BulletinWhitelistEntry;
export type WhitelistEntriesByChain = Partial<{
    "*": WhitelistEntry[];
    asset_hub_paseo: WhitelistEntry[];
